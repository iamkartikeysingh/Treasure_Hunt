...
choice1 = input("You are on the middle of a mysterious island. You only have two ways to go, Left or Right. Where do you want to go? ").lower()
if choice1 == "left":
    print("You arrived at an old dockyard. Looks like someone lives here and makes his living by doing fishing.\n")
    choice2=input("Do you want to wait for the fisherman or swim forward? ").lower()
    if choice2 == "wait":
        ...
        choice3=input("There are 3 doors in front of you - Red, Yellow and Blue. The treasure is on the other side of one of these doors but if you pick the wrong door you die. ").lower()
        if choice3 == "yellow":
        ...
        print("Hmmmmm... You became a tasty dinner for the crocodiles. Game Over")
else:
